...
* Functions:
* ------------
* Element<Data> value(Key key);   --returns the value of every key
* bool save(Key key, Element<Data> elem); --saves the element in the database
* Keys insertchild(Keys A); --inserts children to a key in the database
* bool editkeys(Key key, Element<Data> elem); --edits the data in the database
